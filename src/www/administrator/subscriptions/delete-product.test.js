...
describe('/administrator/subscriptions/delete-product', function () {
  ...
  describe('before', () => {
    it('should bind data to req', async () => {
      ...
      const req = TestHelper.createRequest(`/administrator/subscriptions/delete-product?productid=${administrator.product.id}`)
      req.account = administrator.account
      req.session = administrator.session
      await req.route.api.before(req)
  ...
  describe('submit', () => {
    it('should delete product (screenshots)', async () => {
      ...
      req.screenshots = [
        ...
        { click: `/administrator/subscriptions/delete-product?productid=${administrator.product.id}` },
        { fill: '#submit-form' }
      ]
