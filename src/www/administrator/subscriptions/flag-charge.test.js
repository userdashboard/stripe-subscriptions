...
describe('/administrator/subscriptions/flag-charge', function () {
  ...
  before(async () => {
    ...
    const req = TestHelper.createRequest(`/administrator/subscriptions/flag-charge?chargeid=${user.charge.id}`)
    ...
    req.screenshots = [
      ...
      { click: `/administrator/subscriptions/flag-charge?chargeid=${user.charge.id}` },
      { fill: '#submit-form' }
    ]
