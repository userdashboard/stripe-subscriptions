...
describe('/administrator/subscriptions/publish-coupon', function () {
  ...
  describe('exceptions', () => {
    ...
    it('should reject published coupon', async () => {
      ...
      const req = TestHelper.createRequest(`/administrator/subscriptions/publish-coupon?couponid=${administrator.coupon.id}`)
      req.account = administrator.account
      req.session = administrator.session
      let errorMessage
      try {
  ...
  describe('submit', () => {
    it('should publish coupon (screenshots)', async () => {
      ...
      req.screenshots = [
        ...
        { click: `/administrator/subscriptions/publish-coupon?couponid=${administrator.coupon.id}` },
        { fill: '#submit-form' }
      ]
