...
describe('/administrator/subscriptions/revoke-subscription-coupon', function () {
  ...
  describe('exceptions', () => {
    ...
    it('should reject subscription without discount', async () => {
      ...
      const req = TestHelper.createRequest(`/administrator/subscriptions/revoke-subscription-coupon?subscriptionid=${user.subscription.id}`)
      req.account = administrator.account
      req.session = administrator.session
      let errorMessage
      try {
  ...
  describe('submit', () => {
    it('should remove coupon (screenshots)', async () => {
      ...
      req.screenshots = [
        ...
        { click: `/administrator/subscriptions/revoke-subscription-coupon?subscriptionid=${user.subscription.id}` },
        { fill: '#submit-form' }
      ]
