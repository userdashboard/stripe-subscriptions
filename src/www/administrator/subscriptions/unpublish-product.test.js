...
describe('/administrator/subscriptions/unpublish-product', function () {
  ...
  describe('exceptions', () => {
    ...
    it('should never published product', async () => {
      ...
      const req = TestHelper.createRequest(`/administrator/subscriptions/unpublish-product?productid=${administrator.product.id}`)
      req.account = administrator.account
      req.session = administrator.session
      let errorMessage
      try {
  ...
  describe('submit', () => {
    it('should unpublish product (screenshots)', async () => {
      ...
      req.screenshots = [
        ...
        { click: `/administrator/subscriptions/unpublish-product?productid=${administrator.product.id}` },
        { fill: '#submit-form' }
      ]
