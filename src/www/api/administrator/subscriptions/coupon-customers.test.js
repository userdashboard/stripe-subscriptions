...
describe('/api/administrator/subscriptions/coupon-customers', () => {
  describe('CouponCustomers#GET', () => {
    it('should return list of customers on coupon', async () => {
      ...
      const req = TestHelper.createRequest(`/api/administrator/subscriptions/coupon-customers?customerid=${user.customer.id}`, 'GET')
