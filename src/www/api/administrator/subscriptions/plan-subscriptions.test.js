...
describe('/api/administrator/subscriptions/plan-subscriptions', () => {
  describe('PlanSubscriptions#GET', () => {
    it('should return list of subscriptions on plan', async () => {
      ...
      const req = TestHelper.createRequest(`/api/administrator/subscriptions/plan-subscriptions?planid=${user.plan.id}`, 'GET')
