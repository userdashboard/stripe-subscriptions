...
describe('/api/administrator/subscriptions/product-charges', () => {
  describe('ProductCharges#GET', () => {
    it('should limit charges on product to one page', async () => {
      ...
      const req = TestHelper.createRequest(`/api/administrator/subscriptions/product-charges?productid=${product.id}`, 'GET')
