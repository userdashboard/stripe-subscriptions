...
describe('/api/administrator/subscriptions/product-subscriptions', () => {
  describe('ProductSubscriptions#GET', () => {
    it('should return list of subscriptions on product', async () => {
      ...
      const req = TestHelper.createRequest(`/api/administrator/subscriptions/product-subscriptions?productid=${user.product.id}`, 'GET')
