...
describe('/api/administrator/subscriptions/refunds', () => {
  describe('Refunds#GET', () => {
    it('should limit refunds to one page', async () => {
      ...
      await TestHelper.createRefund(administrator1, user1.charge)
      ...
      const refund2 = await TestHelper.createRefund(administrator2, user2.charge)
      ...
      await TestHelper.loadCharge(user, user3.subscription.id)
