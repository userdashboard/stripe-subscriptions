...
describe('/api/user/subscriptions/card-disputes', () => {
  describe('Carddisputes#GET', () => {
    it('should limit disputes on card to one page', async () => {
      ...
      const req = TestHelper.createRequest(`/api/user/subscriptions/card-disputes?cardid=${user.card.id}`, 'GET')
