...
describe('/api/user/subscriptions/plan-subscriptions-count', async () => {
  describe('PlanSubscriptionsCount#GET', () => {
    it('should count all subscriptions on plan', async () => {
      ...
      const req = TestHelper.createRequest(`/api/user/subscriptions/plan-subscriptions-count?planid=${administrator.plan.id}`, 'GET')
