...
describe.only('/api/user/subscriptions/upcoming-invoices-count', async () => {
  describe('UpcomingInvoicesCount#GET', () => {
    it('should count published plans', async () => {
      ...
      const req = TestHelper.createRequest(`/api/user/subscriptions/upcoming-invoices-count`, 'GET')
